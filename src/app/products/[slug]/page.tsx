    ...
    <div className="py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <nav className="text-sm mb-8">
          <Link href="/products" className="text-[--color-brand-light] hover:underline">Products</Link>
          <span className="mx-2 text-gray-400">/</span>
          <span className="text-gray-600">{category}</span>
        </nav>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="aspect-[4/3] bg-gradient-to-br from-[--color-brand] to-[--color-brand-dark] rounded-lg flex items-center justify-center">
            <span className="text-white/20 text-9xl font-bold">{category.charAt(0)}</span>
          </div>

          <div>
            <h1 className="text-3xl font-bold text-[--color-brand] mb-4">{category}</h1>
            ...
            <div className="bg-gray-50 rounded-lg p-6 mb-6">
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-[--color-brand-accent] rounded-full mt-2 shrink-0" />
