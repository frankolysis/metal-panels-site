  ...
  return (
    <div className="py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-[--color-brand] mb-4">Products</h1>
          ...
          {PRODUCT_CATEGORIES.map((category) => (
            ...
            >
              <div className="bg-white border border-gray-200 rounded-lg overflow-hidden transition-shadow hover:shadow-lg">
                <div className="aspect-[4/3] bg-gradient-to-br from-[--color-brand] to-[--color-brand-dark] relative">
                  <div className="absolute inset-0 flex items-center justify-center text-white/20 text-6xl font-bold">
                    {category.charAt(0)}
                  </div>
                </div>
                <div className="p-4">
                  <h2 className="font-semibold text-[--color-brand] group-hover:text-[--color-brand-accent] transition-colors">
                    {category}
                  </h2>
                  <p className="text-sm text-[--color-brand-accent] mt-1 group-hover:underline">
                    View Product &rarr;
                  </p>
                </div>
              </div>
