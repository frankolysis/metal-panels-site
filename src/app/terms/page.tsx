  ...
  return (
    <div className="py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-brand mb-8">Terms &amp; Conditions</h1>
        <div className="prose prose-lg max-w-none text-gray-700">
          <p>Welcome to {SITE_NAME}. By using our website, you agree to the following terms and conditions.</p>
          <h2 className="text-2xl font-bold text-brand mt-8 mb-4">Use of Website</h2>
          ...
          <h2 className="text-2xl font-bold text-brand mt-8 mb-4">Intellectual Property</h2>
          ...
          <h2 className="text-2xl font-bold text-brand mt-8 mb-4">Product Information</h2>
