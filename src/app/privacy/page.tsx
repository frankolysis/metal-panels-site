    ...
    <div className="py-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none text-gray-700">
          ...
          <h2 className="text-2xl font-bold text-brand mt-8 mb-4">How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-bold text-brand mt-8 mb-4">Data Protection</h2>
          <p>We implement appropriate security measures to protect your personal information from unauthorized access, alteration, or disclosure.</p>
          <h2 className="text-2xl font-bold text-brand mt-8 mb-4">Contact</h2>
          <p>For privacy-related questions, contact us at <a href={"mailto:" + COMPANY_EMAIL} className="text-brand-light">{COMPANY_EMAIL}</a>.</p>
        </div>
      </div>
    </div>
  );
