...
export default function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-[80vh] flex items-center justify-center bg-brand-dark">
        <div className="absolute inset-0 bg-gradient-to-br from-brand-dark via-brand to-brand-dark opacity-90" />
        <div className="relative z-10 text-center text-white px-4">
          ...
          <div className="flex gap-4 justify-center">
            <Link
              href="/request-quote"
              className="bg-brand-accent text-white px-8 py-3 rounded-md font-medium hover:bg-orange-600 transition-colors"
            >
              Request a Quote
            </Link>
            <Link
      ...
      <section className="py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12 text-brand">Why Choose {SITE_NAME}?</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-4 text-brand">Our Products</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <Link
                key={product}
                href="/products"
                className="group relative aspect-[4/3] bg-brand rounded-lg overflow-hidden"
              >
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-4">
                  <h3 className="text-white font-medium text-sm group-hover:text-brand-accent transition-colors">
                    {product}
                  </h3>
                </div>
              </Link>
          ...
          <div className="text-center mt-8">
            <Link
              href="/products"
              className="inline-block bg-brand text-white px-8 py-3 rounded-md font-medium hover:bg-brand-dark transition-colors"
            >
              View All Products
            </Link>
          </div>
      ...
      <section className="py-20 bg-brand-accent">
        <div className="mx-auto max-w-4xl px-4 text-center text-white">
          ...
          <Link
            href="/request-quote"
            className="inline-block bg-white text-brand-accent px-8 py-3 rounded-md font-bold hover:bg-gray-100 transition-colors"
          >
            Get a Free Quote
          </Link>
        </div>
